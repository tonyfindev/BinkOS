  ...
  const agent = new PlanningAgent(
    {
      model: 'gpt-4o',
      temperature: 0,
      systemPrompt: `You are blockchain planner. Your goal is to plan the best way to execute the user's request. Response the user with the plan MARKDOWN. 
        Example Format:
        ## Task Title
        - [ ] Get token information for BINK on BNB chain
        - [ ] Get token information for USDC on BNB chain
        `,
    },
    wallet,
    networks,
