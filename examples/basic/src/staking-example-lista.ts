...
async function main() {
  ...
  const lista = new ListaProvider(provider, 56);
  console.log('🚀 ~ main ~ lista:', lista);
  ...
  // const claimableBalances = await lista.getAllClaimableBalances(
  //   await wallet.getAddress(NetworkName.BNB),
  // );
  // console.log('🚀 ~ main ~ claimableBalances:', claimableBalances);
  ...
  //   input: `Stake 0.001 BNB on Lista protocol on BNB Chain`,
  // });
  ...
  //   input: `Unstake 0.0029 BNB from Lista protocol on BNB Chain`,
  // });
  ...
  //   input: `Stake 5% of my BNB balance on Lista protocol`,
  // });
  ...
  //   input: `Stake $10 worth of BNB on Lista`,
  // });
  ...
  //   input: `Stake 0.5 of token  on Lista`,
  // });
  ...
  //   input: `Redeem all vBNB tokens from Lista to get back my BNB`,
  // });
  ...
  //   input: `Stake 0.01 BNB and 0.0222 BUSD on Lista in a single transaction if possible`,
  // });
  ...
  //   input: `Stake 0.1 BNB on Lista with 2% slippage tolerance and make sure it executes within 3 minutes`,
  // });
  ...
  //   input: `Unstake 0.1 BNB from Lista but only if I'll receive at least 0.099 BNB after fees`,
  // });
  ...
  //   input: `Stake 0.05 BNB on Lista but only if the current APY is above 3%`,
  // });
  ...
  //   input: `Unstake half of my BNB from Lista and immediately stake the proceeds on the highest APY pool available`,
  // });
