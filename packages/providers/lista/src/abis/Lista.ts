export const ListaPoolABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: '_validator', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_uuid', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_amount', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: '_validator', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_amount', type: 'uint256' },
      { indexed: false, internalType: 'bool', name: '_delegateVotePower', type: 'bool' },
    ],
    name: 'DelegateTo',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: '_delegateTo', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_votesChange', type: 'uint256' },
    ],
    name: 'DelegateVoteTo',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: '_bnbAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_dailySlisBnb', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_days', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_remainingSlisBnb', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_account', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_amountInSlisBnb', type: 'uint256' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: '_annualRate', type: 'uint256' }],
    name: 'SetAnnualRate',
    type: 'event',
  },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: '_minBnb', type: 'uint256' }],
    name: 'SetMinBnb',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_validator', type: 'address' },
      { indexed: false, internalType: 'address', name: '_credit', type: 'address' },
      { indexed: false, internalType: 'bool', name: 'toRemove', type: 'bool' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_amountInSlisBnb', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: '_amountToUndelegate', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: '_slisBnbWithdrawLimit', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'refund',
    outputs: [
      { internalType: 'uint256', name: 'dailySlisBnb', type: 'uint256' },
      { internalType: 'uint256', name: 'remainingSlisBnb', type: 'uint256' },
      { internalType: 'uint256', name: 'lastBurnTime', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  { inputs: [], name: 'toggleVote', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'totalDelegated',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'undelegateFrom',
    outputs: [{ internalType: 'uint256', name: '_actualBnbAmount', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
